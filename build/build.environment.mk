...
REF_NOTIFY_SHARP = $(LIBS_SYSTEM) $(LIBS_DBUS) $(GTKSHARP_LIBS) $(GLIBSHARP_LIBS)
LIBS_NOTIFY_SHARP = -r:$(DIR_BIN)/NotifySharp.dll
LIBS_NOTIFY_SHARP_DEPS = $(REF_NOTIFY_SHARP) $(LIBS_NOTIFY_SHARP)

REF_FRIENDFACE = $(LIBS_SYSTEM) $(GTKSHARP_LIBS) $(LIBS_MONO_POSIX)
LIBS_FRIENDFACE = -r:$(DIR_BIN)/FriendFace.dll
LIBS_FRIENDFACE_DEPS = $(REF_FRIENDFACE) $(LIBS_FRIENDFACE)
