...
namespace CmisSync.Lib.Sync
{
    public partial class SyncFolderSyncronizer : SyncFolderSyncronizerBase
    {
            ...
            private void ChangeLogThenCrawlSync(IFolder remoteFolder, string localFolder)
            {
                ...
                int pollInterval = SyncFolderInfo.PollInterval;
                ...
                if (SyncFolderInfo != null)
                    features = SyncFolderInfo.SupportedFeatures;
                ...
                if (lastTokenOnClient == null)
                {
                    ...
                    CrawlRemote(remoteFolder, SyncFolderInfo.LocalPath, new List<string>(), new List<string>());
