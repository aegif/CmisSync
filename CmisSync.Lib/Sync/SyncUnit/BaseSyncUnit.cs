...
using log4net;
/*
namespace CmisSync.Lib.Sync.SyncUnit
{

    /// <summary>
    /// Base sync unit. A sync unit is an aggregation of all 
    /// information and status of one folder tag in configuration xml:
    ///   - CMIS repository config
    ///   - Remote folder info
    ///   - Local folder info
    ///   - Sync status
    /// </summary>
    public abstract class BaseSyncUnit: IDisposable
    {
        /// <summary>
        /// Log.
        /// </summary>
        private static readonly ILog Logger = LogManager.GetLogger (typeof (BaseSyncUnit));
