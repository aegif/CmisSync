...
namespace CmisSync.Lib
{
    ...
    public class ListenerTcp : ListenerBase
    {
        ...
        public ListenerTcp(Uri server, string folder_identifier)
                    ...
                    try
                    {
                        ...
                        while (this.socket.Available < 1)
                        {
                            try
                            {
                                ...
                                if (i == timeout)
                                {
                                    Logger.Info("ListenerTcp | Pinging " + Server);
                                    ...
                                    Logger.Info("ListenerTcp | Received pong from " + Server);
                                ...
                                else
                                {
                                    ...
                                    if (sleepiness <= 0)
                                    {
                                        Logger.Info("ListenerTcp | System woke up from sleep");
