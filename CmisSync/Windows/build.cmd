...
if "%1"=="installer" (
	if exist "%wixBinDir%" (
	  if exist "%~dp0\..\..\bin\Oris4Sync.msi" del "%~dp0\..\..\bin\Oris4Sync.msi"
		...
		"%wixBinDir%\light" -ext WixUIExtension -ext WixUtilExtension -ext WiXNetFxExtension -cultures:en-us CmisSync.wixobj plugins.wixobj -droot="%~dp0\..\.." -dpluginsdir="%~dp0\..\..\bin\plugins"  -o "%~dp0\..\..\bin\Oris4Sync.msi" 
		if exist "%~dp0\..\..\bin\Oris4Sync.msi" echo Oris4Sync.msi created.
	) else (
